...
public class EmployeeController {
	...
	@GetMapping(path = "/empapp/employees")
	...
	@PostMapping(path = "/empapp/employees")
	...
	@PutMapping(path = "/empapp/employees")
	...
	@GetMapping(path = "/empapp/employees/{empId}")
	...
	@DeleteMapping(path = "/empapp/employees/{empId}")
